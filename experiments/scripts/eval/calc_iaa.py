...
if __name__ == "__main__":
    annotator1 = 'michael'
    annotator2 = 'benji'
    output_file = f'data/my_data/output/155d4_tmp_{annotator1}_{annotator2}_v2'
    _annot1_file = f'data/my_data/groups/group_a/155d4_temp_michael.json'
    _annot2_file = f'data/my_data/groups/group_a/155d4_temp_benji.json'
