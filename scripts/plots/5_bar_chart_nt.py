...
scores = {
    "CoT": [60.2, 48.0, 0.0, 0.0, 27.5, 3.0], # CoT
    "Global": [57.2, 50.8, 11.1, 13.3, 33.9, 18.6], # Global
    "TimeLine": [62.5, 60.9, 11.0, 12.6, 30.7, 22.8], # TimeLine
...
plt.title("NarrativeTime", fontsize=18, fontweight='bold')
