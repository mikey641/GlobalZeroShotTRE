...
def generate_xml_sents(mentions, pairs, data, doc_id):
    ...
    for p in pairs:
        ...
        final_tokens = list()
        if str(ment1['sent_id']) == str(ment2['sent_id']):
            if ment_1_start > ment_2_start:
                ment_1_start, ment_2_start = ment_2_start, ment_1_start
                ment_1_end, ment_2_end = ment_2_end, ment_1_end
                ment1, ment2 = ment2, ment1
                p['_firstId'], p['_secondId'] = p['_secondId'], p['_firstId']
                p['_relation'] = get_reverse_label(p['_relation'])
...
if __name__ == '__main__':
    ...
    _input_folder = 'data/MATRES/in_my_format/test_less20'
    _output_file = 'data/bayesian_format/testset_20events_matres.xml'
