    ...
    for file1 in os.listdir(input_folder):
        for file2 in os.listdir(input_folder):
            ...
            if split_file1[0] == split_file2[0] and split_file1[0] not in done:
                ...
                if len(mentions1) != len(mentions2) or num_pairs1 != num_pairs2 or expected_pairs1 != expected_pairs2:
                ...
                tmp_score, tmp_diff, tmp_unagreed, coref_score, coref_diff, coref_unagreed, cause_score, cause_diff, cause_unagreed = calculate_iaa(
                    mentions1, data1["allPairs"], mentions2, data2["allPairs"])
                ...
                tot_mentions.append(len(mentions1))
...
if __name__ == "__main__":
    ...
    annotator1 = 'netta'
    annotator2 = 'michael'
    output_file = f'data/my_data/output/148d5_tmp_{annotator1}_{annotator2}_v4'
