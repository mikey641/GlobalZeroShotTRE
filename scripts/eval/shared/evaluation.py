...
from scripts.utils.classes.datasets_type import OMNITEMP_DATASET_NAME, MATRES_DATASET_NAME, TBD_DATASET_NAME, NARRATIVE_DATASET_NAME, MAVEN_DATASET_NAME
...
def evaluation(all_golds, all_preds, gold_for_trans, pred_for_trans, dataset_type, print_confusion=True):
    ...
    if dataset_name in [MATRES_DATASET_NAME, OMNITEMP_DATASET_NAME, MAVEN_DATASET_NAME]:
